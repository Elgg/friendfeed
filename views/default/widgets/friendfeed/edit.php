<?php
	...
	/**
	 * Elgg Friendfeed widget plugin edit page
	 * 
	...
	if (empty($vars['entity']->num_display))
		$vars['entity']->num_display = 5;

?>

	<p>
		<?php echo elgg_echo("friendfeed:username"); ?>
		<input type="text" name="params[username]" value="<?php echo htmlentities($vars['entity']->username); ?>" />	
	</p>
	<p>
		<?php echo elgg_echo("friendfeed:apikey"); ?>
		[<a href="http://friendfeed.com/remotekey" target="_blank"><?php echo elgg_echo('friendfeed:apikeyfind'); ?></a>]
		<input type="text" name="params[apikey]" value="<?php echo htmlentities($vars['entity']->apikey); ?>" />	
	</p>
	<p>
		<?php echo elgg_echo("friendfeed:num_display"); ?>:
